...
*****************************************************************************/
	...
	*/
	...
	$query	= "SELECT count(*) AS total	FROM
				...
				WHERE UM.user_unsubscribed > 0 ".$joinquery;
	...
	if($total_condition['total_condition']>0){
		...
		$sql = "SELECT UM.user_fname, UM.user_lname, UM.user_id, UM.user_alt_email as user_email, 
...
<select name="toY">
  ...
  <?
				  ...
				  <TABLE class="listTableStyle" cellSpacing=1 cellPadding=2 width="553">
                    ...
                    <TBODY>
                      ...
                      <TR class="tableHeaderColor" >
                        ...
                        <TD width="28%" align="center" >Date of Joining </TD>

                        <TD width="28%" align="center" >Date of Unsubscription</TD>
			...
			?><tr  <? if(($key%2) ==1){?> bgcolor="#FFFFFF" <? } ?> >
                              ...
                              <TD width="37%" height="19" align="left" style="padding-left:10px;"><a href="javascript:;" onMouseOver="myFunction('<?=$val['user_id']?>')" onClick="return overlib(INARRAY, <?=$val['user_id']?>, CAPTION, '<?php
                              ...
                              <TD width="28%" height="19" align="center" style="padding-left:10px;"><? echo $val['user_doj']?></TD>

                              <TD width="28%" height="19" align="center" style="padding-left:10px;"><? echo $val['user_req_unsubscribe']?></TD>
					...
					<tr><?php if($noOfPage > 1) { ?>
						...
						<a href="report_unsubscribed.php?pageNo=1&langId=<?=$lanId?>&maxrows=<?=$_REQUEST['maxrows']?>&param=<?=$param?>">

						<img src="images/mail-arrowfg.gif" border=0 width="20" height="20" align="absmiddle" alt="First Page"></a>

						<a href="report_unsubscribed.php?pageNo=<?=$prev?>&langId=<?=$lanId?>&maxrows=<?=$_REQUEST['maxrows']?>&param=<?=$param?>">
						...
						<select name="pageNo" class="paragraph"  onChange="form.submit()">
							...
							?>
							 ...
							 <a href="report_unsubscribed.php?pageNo=<?=$next?>&langId=<?=$lanId?>&maxrows=<?=$_REQUEST['maxrows']?>&param=<?=$param?>">

							<img src="images/mail-arrowrg.gif" border=0 width="20" height="20" align="absmiddle" alt="Next Page"></a>

							<a href="report_unsubscribed.php?pageNo=<?=$noOfPage?>&langId=<?=$lanId?>&maxrows=<?=$_REQUEST['maxrows']?>&param=<?=$param?>">
