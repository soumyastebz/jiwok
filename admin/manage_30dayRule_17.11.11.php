<?php
	...
	$query	=	"SELECT count(*) as max,MT.*,UM.user_email FROM user_master UM LEFT JOIN manage_30dayRule MT on UM.user_id = MT.user_id";	
	...
	if($_REQUEST['pageNo']){
		...
		$result = $payObj->_showPage30datRule($totalRecs,$_REQUEST['pageNo'],$_REQUEST['maxrows'],$field,$type,$searchQuery);
	}
	else{
...
function suspend(params,textid)
{	
                       ...
                       <tbody>
						...
						?>
                         <tr class="listingTable">
                           ...
                           <td align="center"><?php if($genObj->_output($row->status)	< 1) echo "<img src=\"images/y.gif\" width=\"14\" height=\"14\" title=\"Active\">"; else echo "<img src=\"images/n.gif\" width=\"14\" height=\"14\" title=\"Expired\">";?></td>                           
