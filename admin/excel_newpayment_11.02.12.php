<? 
 //for generating the excell sheet for the report
    ...
    $worksheet->write(1,2, 'Email', $format_bold);   
	$worksheet->write(1,3, 'Amount', $format_bold);
	$worksheet->write(1,4, 'Currency', $format_bold);
	$worksheet->write(1,5, 'Payment date', $format_bold);
	$worksheet->write(1,6, 'Exp.date', $format_bold);
	...
	if(count($memberList)>0){
        ...
        $worksheet->write($row,3, $val['payment_amount']);		
