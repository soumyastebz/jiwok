...
$fromSqlTrans  = " from payment b WHERE  b.payment_userid in (select a.user_id from jiwok_referrals a where a.referrer_user_id=0 #paidCond#	".$fltrCond." ) and b.payment_status=1 ";
...
<tr>
                            ...
                            <tr  <? if(($key%2) ==0){?> bgcolor="#FFFFFF" <? } ?> >
                              ...
                              <TD width="17%" height="19" align="left" style="padding-left:10px;"><? echo $val['referred_medium']?></TD>
