<?php
 ...
 // echo $textmessage1;
	...
	if($page_name!= "")//for other admins
	{
		$query = "SELECT count(*) as max FROM user_master WHERE user_language IN (".$admin_lang. ") and user_type=".$siteUsersConfig['MEMBER'];
	}
	else
	{
	...
	if($_REQUEST['pageNo']){
		...
		$result = $memObj->_showPage($siteUsersConfig['MEMBER'],$totalRecs,$_REQUEST['pageNo'],$_REQUEST['maxrows'],$field,$type,$searchQuery,$page_name,$admin_lang);
