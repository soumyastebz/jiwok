...
$query = "SELECT count(DISTINCT PQ.user_id) as max FROM program_queue AS PQ LEFT JOIN user_master AS UM ON UM.user_id	=	PQ.user_id WHERE PQ.user_name	!=	''	AND	UM.user_type=".$siteUsersConfig['MEMBER'] ;
if($searchQuery)
	$query .= 	$searchQuery; 	
...
$result 	= 	$memObj->_showPageQueue($siteUsersConfig['MEMBER'],$totalRecs,$_REQUEST['pageNo'],$_REQUEST['maxrows'],$field,$type,$searchQuery);
}
else
{
