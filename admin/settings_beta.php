...
*****************************************************************************/
	...
	*/
	...
	if($_POST['contactEmailUpdate']||$_POST['returnEmailUpdate']||$_POST['bounceEmailUpdate'] || $_POST['maxCountUpdate'] || $_POST['freeDaysUpdate'] || $_POST['memFee'] || $_POST['memShipUnsubscribeUpdate'] || $_POST['dis_limit_update']){
			...
			if($_POST['ref_set_update']){
            
                if(trim($_POST['referel_setting'])=='')
                    $errorMsg[] =   "Enter No Of Referrels Required";
             elseif(!is_numeric(trim($_POST['referel_setting'])))
                    $errorMsg[] =   "Enter a number for Referrels needed ";
                else
                   $updateSettings =   "update settings set referel_setting='".$objGen->_clean_data($_POST['referel_setting'])."'"; 
            }
	...
	if(!$_POST['contactEmailUpdate']&&!$_POST['returnEmailUpdate']&&!$_POST['bounceEmailUpdate']&&!$_POST['maxCountUpdate']&&!$_POST['freeDaysUpdate']&&!$_POST['memFeeUpdate']&&!$_POST['memShipUnsubscribeUpdate']){
		...
		foreach($result as $key=>$data){
			...
			$_POST['referel_setting']  							=  $objGen->_output($data['referel_setting']);
		}
...
<tr> 
              ...
              <tr> 
				...
				<TABLE cellSpacing=0 cellPadding=0 border=0 align="center">
                    <TR> 
                      <TD valign="top" width=564 bgColor=white> 
			  			   ...
			  			   <form name="frmsettings" action="settings_beta.php" method="post">
				...
				<br/>
                <table width="90%" cellspacing="1" cellpadding="2" align="center" class="listTableStyle">
					<tbody> 
						<tr class="tableHeaderColor"><td align="center" colspan="3">&nbsp; <b><?=$heading3?></b></td></tr>
                    </tbody>
				</table>    
				<br/>
				<table width="90%" cellspacing="1" cellpadding="2" align="center" class="listTableStyle">
					<tbody> 
						<tr class="tableHeaderColor">
							<td colspan="3">&nbsp;Set Referrels Required</td>
						</tr>
						<tr class="listingTable">
							<td width="176">Referrels Required For Free Month Subscription:</td>
							<td width="258">
								<input type="text" maxlength="30" size="25" name="referel_setting"  value="<?=$_POST['referel_setting']?>"/>
                            </td>
                            <td width="56" align="center" class="listTableStyle">
								<input type="submit" value="Update" name="ref_set_update">
							</td>
						</tr>
					</tbody>
				</table>
