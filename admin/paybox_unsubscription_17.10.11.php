                       ...
                       <tbody>
						...
						?>
                         <tr class="listingTable">
                           ...
                           <td align="center"><?php if($genObj->_output($row->status)	== 'ACTIVE') echo "<img src=\"images/y.gif\" width=\"14\" height=\"14\" title=\"Active\">"; elseif($genObj->_output($row->status)	== 'UNSUBSCRIBED') echo "<img src=\"images/n.gif\" width=\"14\" height=\"14\" title=\"Unsubscribed\">"; else echo "<img src=\"images/y.gif\" width=\"14\" height=\"14\" title=\"Expired\">";?></td>
                           <td align="center">&nbsp;<?php if($genObj->_output($row->status) != 'Unsubscribed')?><a href = "paybox_unsubscription.php?id=<?=$row->id?>&pageNo=<?=$_REQUEST['pageNo']?>&maxrows=<?=$_REQUEST['maxrows']?>&langId=<?=$lanId?>&keyword=<?=$genObj->_output($_REQUEST['keyword'])?>&action=unsubscribe" class="smallLink" onClick="return confirm('Are you sure that you want to Unsubscribe this user from paybox?.If yes click Ok, if not click Cancel.')"><strong>Unsubscribe</strong></a></td>
