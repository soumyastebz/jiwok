...
//	error_reporting(0);
	...
	*/
	...
	echo	$sql = "SELECT UM.user_fname, UM.user_lname, PS.user_id, 
					...
					$whereSql $joinquery
					GROUP BY PS.user_id ORDER BY COUNT(PS.user_id) DESC, UM.user_fname ASC";
		//echo $sql;
	...
	////////////////////////////////////Pagination ends here/////////////////////////////////////////
		if($totalRecs > 0){
			...
			$sql1	=	"SELECT PS.user_id, PS.program_id, PD.program_title, 
						...
						FROM programs_subscribed AS PS 
						INNER JOIN program_detail AS PD ON (PD.program_master_id = PS.program_id ".$pgmquery." )
...
LEFT JOIN user_master AS UM ON UM.user_id = PS.user_id WHERE program_type='program' AND subscribe_status='1' ". $joinquery. $whereSql . " 
...
program_detail AS PD  ON  ( PD.program_master_id = PS.program_id ".$pgmquery." ) ".$payment_qry. "   LEFT JOIN user_master AS 

UM ON UM.user_id = PS.user_id WHERE program_type='program' AND subscribe_status='1' ".$joinquery . $whereSql . " 
 GROUP BY PS.program_id";
