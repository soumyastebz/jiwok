...
error_reporting(1);
	...
	if($_POST['grouping']!='')
	{
		...
		{				
				$fileNameArray[25] = 'Query25.1.txt';		
		}			
		if($grouping=='Country')
		{				
				$fileNameArray[25] = 'Query25.2.txt';	
		}			
		if($grouping=='Gender')
		{			
				$fileNameArray[25] = 'Query25.3.txt';				
		}			
		if($grouping=='Age')
		{			
				$fileNameArray[25] = 'Query25.4.txt';	
		}			
		if($grouping=='origin')
			{			
				$fileNameArray[25] = 'Query25.5.txt';				
		}
