...
error_reporting(1);
	...
	$_POST['report_criteria']  =13;
	if($_POST['grouping']!='')
	{
		 $grouping = trim($_POST['grouping']);
		if($grouping=='brand_name')
			{			
				$fileNameArray[13] = 'Query13.1.txt';		
		}			
		if($grouping=='Country')
		{				
				$fileNameArray[13] = 'Query13.2.txt';	
		}			
		if($grouping=='Gender')
		{				
				$fileNameArray[13] = 'Query13.3.txt';				
		}			
		if($grouping=='Age')
		{				
				$fileNameArray[13] = 'Query13.4.txt';	
		}				
		if($grouping=='origin')
		{			
				$fileNameArray[13] = 'Query13.5.txt';				
		}			
	...
	if($_REQUEST['export_to']== 2)
		$fileNameArray[1] = 'QueryExport13.txt';
                        ...
                        <td width="11" height="9"><img src="images/top_right.jpg" width="9" height="9"></td>
                          ...
                          <tr> 
                            ...
                            <td valign="top"> 
                                ...
                                <tr>
                                          <td height="6" colspan="4" align="center" valign="bottom" class="sectionHeading" style="font-size:16px; padding-top:10px;">Revenue Reports</td>
                                 </tr>
                                 ...
                                 <tr>
                                   ...
                                   <?php } ?>     
                                    <TR> 
                                      ...
                                      <form name="reportFrm" action="report_revenue.php" method="post" enctype="multipart/form-data" onSubmit="return dateValidation();">
                           ...
                           ?>
                                          ...
                                          <td width="115" align="left" valign="top" style="padding-left:10px;"><strong>Age</strong></td>
                                          <td width="165" valign="top" ><input type="text" name="user_fromage" id="user_fromage" size="5" value="<?=trim($_POST['user_fromage'])?>" />&nbsp;- &nbsp;<input type="text" name="user_toage" id="user_toage" size="5" value="<?=trim($_POST['user_toage'])?>"/></td>
                                        </tr>
                                        <tr >
                                        ...
                                        <tr>
                                          <td width="222" align="left" valign="top" style="padding-left:20px;padding-top:10px;">&nbsp;<strong>Brand</strong>&nbsp;&nbsp;</td>
                                          <td width="248"  style="padding-top:10px;" valign="top">
                                          <span style="vertical-align:top">
                                       ...
                                       <tr><td colspan="8" height="30">&nbsp;</td>
                                        ...
                                        <tr >
                                        <td width="222" style="padding-left:20px; padding-top:30px;"><strong>Filter Date</strong></td>
