...
error_reporting(1);
	...
	if($_POST['grouping']!='')
	{
		...
		if($grouping=='brand_name')
			$fileNameArray[10] = 'Query10.1.txt';
		if($grouping=='Country')
			$fileNameArray[10] = 'Query10.2.txt';
		if($grouping=='Gender')
			$fileNameArray[10] = 'Query10.3.txt';
		if($grouping=='Age')
			$fileNameArray[10] = 'Query10.4.txt';
		if($grouping=='origin')
			$fileNameArray[10] = 'Query10.5.txt';	
	...
	if($_REQUEST['export_to']== 2)
		$fileNameArray[10] = 'QueryExport10.txt';
...
<div id="overDiv" style="position:absolute; visibility:hidden; z-index:1000;"></div>
                        ...
                        <td width="11" height="9"><img src="images/top_right.jpg" width="9" height="9"></td>
                          ...
                          <tr> 
                            ...
                            <td valign="top"> 
                                ...
                                <tr>
                                    ...
                                    <TR> 
                                      ...
                                      <form name="reportFrm" action="report_training.php" method="post" enctype="multipart/form-data" onSubmit="return dateValidation();">
                           ...
                           ?>
                                          ...
                                          <td width="91" align="left" valign="top" style="padding-left:10px;"><strong>Age</strong></td>
	...
	<span style="vertical-align:top">
                                        ...
                                        <tr>
                                          ...
                                          <td width="289"  style="padding-top:10px;" valign="top">
                                          <span style="vertical-align:top">
                                  ...
                                  <TABLE class="listTableStyle" cellSpacing=1 cellPadding=2 width="100%" border="0">
                                   <? include_once('groupform.php');?>
                                      <TR class="tableHeaderColor" >
										...
										$fname=mysql_field_name($result, $i);
										?>                 
                        			   <TD height="19" align="left" style="padding-left:2px;"><?=htmlentities(stripslashes($row[$fname]))?></TD>
                                        <?php }?>                                    
                                      </tr>
