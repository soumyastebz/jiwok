...
error_reporting(1);
	...
	*/
	...
	while($row = mysql_fetch_array($result,MYSQL_ASSOC))
	{
		...
		$resultArray[$i]['cat'] = $row['User Category'];
	...
	while($row = mysql_fetch_array($result1,MYSQL_ASSOC))
	{
		...
		$cmpArray[$i]['cat'] = 'Registered Not Tested';
		$cmpArray[$i]['catnb'] = 1;
		$i++;
		$cmpArray[$i]['Brand'] = $row['brand'];
		$cmpArray[$i]['cat'] = 'Registered and Tested';
		$cmpArray[$i]['catnb'] = 2;
		$i++;
		$cmpArray[$i]['Brand'] = $row['brand'];
		$cmpArray[$i]['cat'] = 'Subscriber';
		$cmpArray[$i]['catnb'] = 3;
		$i++;
		$cmpArray[$i]['Brand'] = $row['brand'];
		$cmpArray[$i]['cat'] = 'Ex-Subscriber';
		$cmpArray[$i]['catnb'] = 4;
                        ...
                        <td width="11" height="9"><img src="images/top_right.jpg" width="9" height="9"></td>
                          ...
                          <tr> 
                            ...
                            <td valign="top"> 
                                ...
                                <tr>
                                 ...
                                 <!--<?php if($_POST['report_criteria']!='') { ?>
                                  <form name="exportFrm" action="report_subscription_chart.php" method="post" enctype="multipart/form-data">
                                 <tr>
                                           ...
                                           <input type="hidden" name="user_type" id="user_type" value="<?=trim($_POST['user_type'])?>"/>
                                            ...
                                            <input type="hidden" name="user_country_1" id="user_country_1" value="<?=trim($countryCondn)?>"/>
                                             <input type="hidden" name="user_gender_1" id="user_gender_1" value="<?=trim($genderCondn)?>"/> 
                                              <input type="hidden" name="user_brand_1" id="user_brand_1" value="<?=trim($brandCondn)?>"/>  
                                   ...
                                   <?php } ?>    --> 
                                    <TR> 
                                      ...
                                      <form name="reportFrm" action="report_subscription_chart.php" method="post" enctype="multipart/form-data" onSubmit="return dateValidation();">
                           ...
                           ?>
                                          ...
                                          <td width="153" align="left" valign="top" style="padding-left:10px;"><strong>Age</strong></td>
                                        ...
                                        <tr>
                                          <td width="157" align="left" valign="top" style="padding-left:20px;padding-top:10px;">&nbsp;<strong>Brand</strong>&nbsp;&nbsp;</td>
                                          <td width="171"  style="padding-top:10px;" valign="top">
                                          <span style="vertical-align:top">
                                        ...
                                        <tr>
                                         ...
                                         <td width="266"  style="padding-top:10px;" valign="top">  <span style="vertical-align:top">
                                       ...
                                       <tr><td colspan="8" height="30">&nbsp;</td>
                                        ...
                                        <tr >
                                        <td width="157" style="padding-left:20px; padding-top:30px;"><strong>Filter Date</strong></td>
								  ...
								  <!--<TABLE cellSpacing=1 cellPadding=2 width="100" align="right" style=" padding-right:10px;">
                                    <TBODY>
                                    <tr>
                                          <td height="6" colspan="4" align="center" valign="bottom" class="sectionHeading" style="font-size:12px; padding-top:5px; border:1px; background:#999900;"><a href="javascript: void(0)" onClick="popup('googleChart.php?chart=<?php echo $google;?>')">Google Chart</a></td>
                                        </tr>                                      
                                      </tbody>
                                  </table>-->
