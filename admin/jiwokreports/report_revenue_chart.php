...
error_reporting(1);
	...
	*/
	...
	while($row = mysql_fetch_array($result,MYSQL_ASSOC))
	{
		...
		$resultArray[$i]['cat'] = $row['Currency'];
		$resultArray[$i]['Count'] = $row['payment Amount'];
		$i++;
	}	
                            ...
                            <td valign="top"> 
                                ...
                                <tr>
                                    ...
                                    <TR> 
                                      ...
                                      <form name="reportFrm" action="report_revenue_chart.php" method="post" enctype="multipart/form-data" onSubmit="return dateValidation();">
