                                ...
                                <TABLE cellSpacing=0 cellPadding=0 border=0 align="center">
                                    <TR> 
                                      <TD valign='top' width='564' bgColor='white'><table width=553 height="227" border=0 cellpadding=0 cellspacing=0 class="paragraph2">
                                        ...
                                        <tr style="padding-top:10px;">
                                          <td width="89"  height="24" align="left" valign="bottom" style="padding-left:10px;"><strong>Search for&nbsp;&nbsp;&nbsp;&nbsp;</strong></td>
                                          <td width="179"  style="padding-top:10px; font-size:20px;"><select id="report_user" name="report_user" style="font-size:11px;">
                                            <option value="" selected>All</option>
                                            <option value="country">New Register</option>
                                            <option value="country">Register Tested</option>
                                            <option value="country">Register not Tested</option>
                                            <option value="country">Permanent Register</option>
                                          </select></td>
                                          <td width="78"  align="left" valign="bottom" style="padding-left:10px;"><strong>Brand</strong>&nbsp;&nbsp;&nbsp;</td>
                                          <td width="207"  style="padding-top:10px;"><select id="report_brand" name="report_brand"  style="font-size:11px;" multiple>
                                            <option value="0">All</option>
                                            <option value="">Jiwok</option>
                                            <option value="1">Kalenji</option>
                                            <option value="2">Marathon</option>
                                            <option value="3">Nabaji</option>
                                          </select></td>
                                        </tr>
                                        <tr style="padding-top:20px;">
                                          <td align="left" valign="bottom" style="padding-left:10px;padding-top:20px;"><strong>Country</strong>&nbsp;&nbsp;</td>
                                          <td style="padding-top:20px;"><select id="report_country" name="report_country" style="font-size:11px;" >
                                            <option value="" selected>--All--</option>
