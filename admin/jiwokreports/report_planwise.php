...
error_reporting(1);
	...
	if($_POST['grouping']!='')
	{
		...
		{				
				$fileNameArray[3] = 'Query3.1.txt';		
		}			
		if($grouping=='Country')
		{				
				$fileNameArray[3] = 'Query3.2.txt';	
		}			
		if($grouping=='Gender')
		{			
				$fileNameArray[3] = 'Query3.3.txt';				
		}			
		if($grouping=='Age')
		{			
				$fileNameArray[3] = 'Query3.4.txt';	
		}			
		if($grouping=='origin')
		{			
				$fileNameArray[3] = 'Query3.5.txt';				
		}			
	...
	if($_REQUEST['export_to']== 2)
		$fileNameArray[3] = 'QueryExport3.txt';
                        ...
                        <td width="11" height="9"><img src="images/top_right.jpg" width="9" height="9"></td>
                          ...
                          <tr> 
                           ...
                           ?>
                                          ...
                                          <td width="126" align="left" valign="top" style="padding-left:10px;"><strong>Age</strong></td>
                                          <td width="239" valign="top" ><input type="text" name="user_fromage" id="user_fromage" size="5" value="<?=trim($_POST['user_fromage'])?>" />&nbsp;- &nbsp;<input type="text" name="user_toage" id="user_toage" size="5" value="<?=trim($_POST['user_toage'])?>"/></td>
                                        </tr>
                                        <tr >
...
<span style="vertical-align:top">
                                        ...
                                        <tr>
                                          <td width="217" align="left" valign="top" style="padding-left:20px;padding-top:10px;">&nbsp;<strong>Brand</strong>&nbsp;&nbsp;</td>
                                          <td width="168"  style="padding-top:10px;" valign="top">
                                          <span style="vertical-align:top">
