...
error_reporting(1);
	...
	if($_POST['grouping']!='')
	{
		...
		if($grouping=='brand_name')
			$fileNameArray[7] = 'Query7.1.txt';
		if($grouping=='Country')
			$fileNameArray[7] = 'Query7.2.txt';
		if($grouping=='Gender')
			$fileNameArray[7] = 'Query7.3.txt';
		if($grouping=='Age')
			$fileNameArray[7] = 'Query7.4.txt';
		if($grouping=='origin')
			$fileNameArray[7] = 'Query7.5.txt';	
	...
	if($_REQUEST['export_to']== 2)
		$fileNameArray[7] = 'QueryExport7.txt';
                                ...
                                <tr>
                                  ...
                                  <?php if($_POST['report_criteria']!='')  include_once('exportform.php');?>   
                                    <TR> 
                                      ...
                                      <form name="reportFrm" action="report_paymentchange.php" method="post" enctype="multipart/form-data" onSubmit="return dateValidation();">
