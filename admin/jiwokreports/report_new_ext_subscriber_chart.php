...
error_reporting(1);
	...
	$heading = "New Subscriber/Existing Subscriber Reports";
                            ...
                            <td valign="top"> 
                                ...
                                <tr>
                                    ...
                                    <TR> 
                                      ...
                                      <form name="reportFrm" action="report_new_ext_subscriber_chart.php" method="post" enctype="multipart/form-data" onSubmit="return dateValidation();">
