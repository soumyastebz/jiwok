...
error_reporting(1);
	...
	if($_POST['grouping']!='')
	{
		...
		{				
				$fileNameArray[12] = 'Query12.1.txt';		
		}			
		if($grouping=='Country')
		{				
				$fileNameArray[12] = 'Query12.2.txt';	
		}			
		if($grouping=='Gender')
		{	
				$fileNameArray[12] = 'Query12.3.txt';				
		}			
		if($grouping=='Age')
		{				
				$fileNameArray[12] = 'Query12.4.txt';	
		}			
		if($grouping=='origin')
		{				
				$fileNameArray[12] = 'Query12.5.txt';				
		}	
                                ...
                                <tr>
                                  ...
                                  <?php if($_POST['report_criteria']!='')  include_once('exportform.php');?>    
                                    <TR> 
                                      ...
                                      <form name="reportFrm" action="report_new_ext_subscriber.php" method="post" enctype="multipart/form-data" onSubmit="return dateValidation();">
