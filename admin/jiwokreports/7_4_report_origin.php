...
error_reporting(1);
	...
	if($_POST['grouping']!='')
	{
		...
		if($grouping=='brand_name')
			$fileNameArray[2] = 'Query2.1.txt';
		if($grouping=='Country')
			$fileNameArray[2] = 'Query2.2.txt';
		if($grouping=='Gender')
			$fileNameArray[2] = 'Query2.3.txt';
		if($grouping=='Age')
			$fileNameArray[2] = 'Query2.4.txt';
		if($grouping=='origin')
			$fileNameArray[2] = 'Query2.5.txt';	
                        ...
                        <td width="11" height="9"><img src="images/top_right.jpg" width="9" height="9"></td>
                          ...
                          <tr> 
                            ...
                            <td valign="top"> 
                                ...
                                <tr>
                                 ...
                                 <?php if($_POST['report_criteria']!='') { ?>
                                  <form name="exportFrm" action="report_origin.php" method="post" enctype="multipart/form-data">
                                 <tr>
                           ...
                           ?>
                                  ...
                                  <form name="grpFrm" action="report_origin.php" method="post" enctype="multipart/form-data">
                                  <tr >
