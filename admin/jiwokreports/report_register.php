...
error_reporting(1);
	...
	$heading = "New Register/Existing Register Reports";
	$todayDetails = getdate();
	
	$_POST['report_criteria']  =11;
	if($_POST['grouping']!='')
	{
		 $grouping = trim($_POST['grouping']);
		if($grouping=='brand_name')
		{			
				$fileNameArray[11] = 'Query11.1.txt';		
		}			
		if($grouping=='Country')
		{			
				$fileNameArray[11] = 'Query11.2.txt';	
		}			
		if($grouping=='Gender')
		{			
				$fileNameArray[11] = 'Query11.3.txt';				
		}			
		if($grouping=='Age')
		{			
				$fileNameArray[11] = 'Query11.4.txt';	
		}				
		if($grouping=='origin')
		{			
				$fileNameArray[11] = 'Query11.5.txt';				
		}	
	}
	else
	{
	...
	if($_REQUEST['export_to']== 2)
		$fileNameArray[11] = 'QueryExport11.txt';
	...
	$reportTitleArray =  array('1'=>'Subscription Reports','2'=>'Subscribers Origin Reports','3'=>'Subscribers Reports : Plan Wise','4'=>'Subscribers Doing Test : 1 Euro or First Workout','5'=>'Subscriber Reports Using Gift Code','6'=>'1 Euro Transaction Only',
							  '7'=>'1 Euro to 7.9 Euro Next Month','8'=>'Average Monthly Subscribed','9'=>'Paid Subscribers Reports','10'=>'Training Program Most Subscribed','11'=>'New Register/Existing Register Reports','12'=>'Existing Subscriber/New Subscriber Reports','13'=>'Revenue Reports');
                        ...
                        <td width="11" height="9"><img src="images/top_right.jpg" width="9" height="9"></td>
                          ...
                          <tr> 
                            ...
                            <td valign="top"> 
                                ...
                                <tr>
                                          <td height="6" colspan="4" align="center" valign="bottom" class="sectionHeading" style="font-size:16px; padding-top:10px;">Register Reports</td>
                                 </tr>
                                <?php if($_POST['report_criteria']!='')  include_once('exportform.php');?>      
                                    <TR> 
                                      <TD valign='top' bgColor='white'>
                                      <form name="reportFrm" action="report_register.php" method="post" enctype="multipart/form-data" onSubmit="return dateValidation();">
