                          ...
                          <tr> 
                            ...
                            <td valign="top"> 
                                ...
                                <tr>
                                 ...
                                 <?php if($_POST['report_criteria']!='') { ?>
                                  <form name="exportFrm" action="report_subscribtion_main.php" method="post" enctype="multipart/form-data">
                                 <tr>
                                   ...
                                   <?php } ?>     
                                    <TR> 
                                      ...
                                      <form name="reportFrm" action="report_subscribtion_main.php" method="post" enctype="multipart/form-data">
                           ...
                           ?>
                                        ...
                                        <tr>
                                         ...
                                         <td width="270"  style="padding-top:10px;" valign="top"><select id="user_type" name="user_type" style="font-size:11px;" >
                                     ...
                                     <tr>
                                          ...
                                          <option value="1" <?php if($_POST['report_criteria']=='1') echo 'selected';?>>Subscribers Free and Paid</option>
                                          <option value="2" <?php if($_POST['report_criteria']=='2') echo 'selected';?>>Subscribers Origin Reports</option>
                                          <option value="3" <?php if($_POST['report_criteria']=='3') echo 'selected';?>>Report on Subscribers Status: Plan Wise</option>
                                   		  <option value="4" <?php if($_POST['report_criteria']=='4') echo 'selected';?>>Report on Subscribers  doing a Test: 1Eur or First Workout </option>
                                          <option value="5" <?php if($_POST['report_criteria']=='5') echo 'selected';?>>Report on Subscribers using a Gift Code</option>
