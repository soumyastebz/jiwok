...
error_reporting(1);
	...
	if($_REQUEST['export_to']== 2)
		$fileNameArray[14] = 'QueryExport14.txt';
                                ...
                                <tr>
                                 ...
                                 <?php if($_POST['report_criteria']!='')  include_once('exportform.php');?>        
                                    <TR> 
                                      ...
                                      <form name="reportFrm" action="report_oxylane.php" method="post" enctype="multipart/form-data" onSubmit="return dateValidation();">
