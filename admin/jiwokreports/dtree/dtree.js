...
if(chks[i].alt.toLowerCase() == 'check') {
if(chks[i].id == no) {
...
checkStatus (chks[i].value,chks[i]);
 ...
 function checkPar(chkBox) {
  //alert('here');
  //&& chkBox.checked
  if (chkBox.alt.toLowerCase()== 'check' && chkBox.id !=0 ) { // determine the click to select, and not the root directory, then select the parent directory 
  var flag=1;
        var chks = document.getElementsByTagName ('input');
		for(var i = 0; i<chks.length; i++) {
			if(chks[i].alt.toLowerCase() == 'check' && chks[i].value==chkBox.id && chks[i].checked==false) {
				flag=2;
				chks[i].checked = chkBox.checked;
				break;
			}
	...
	//////////////////////////////////
	/*for(var i = 0; i<chks.length; i++) {
			if(chks[i].alt.toLowerCase() == 'check' && chks[i].id==chkBox.id && chks[i].checked==false) {
				flag=2;
				chks[i].checked = chkBox.checked;
				break;
			}
