...
error_reporting(1);
	...
	*/
	...
	$reportQuery = "SELECT Brand,SUM(totalcount) AS Count FROM(".$reportQuery.")AS t5 GROUP BY t5.Brand";	
      ...
      function drawChart() {
	   ...
	   var chart = new google.visualization.ColumnChart(document.getElementById('chart_div'));
        chart.draw(data, {height: 440,
						  ...
						  vAxis: {title: 'Average', titleTextStyle: {color: 'red'}}
                        ...
                        <td width="11" height="9"><img src="images/top_right.jpg" width="9" height="9"></td>
                          ...
                          <tr> 
                            ...
                            <td valign="top"> 
                                ...
                                <tr>
                                    ...
                                    <TR> 
                                      ...
                                      <form name="reportFrm" action="report_avg_month_sub_chart.php" method="post" enctype="multipart/form-data">
                           ...
                           ?>
                                          ...
                                          <td width="184" align="left" valign="top" style="padding-left:10px;"><strong>Age</strong></td>
                                          <td width="57" valign="top" ><input type="text" name="user_fromage" id="user_fromage" size="5" value="<?=trim($_POST['user_fromage'])?>" />&nbsp;- &nbsp;<input type="text" name="user_toage" id="user_toage" size="5" value="<?=trim($_POST['user_toage'])?>"/></td>
                                        </tr>
                                        <tr >
                                        ...
                                        <tr>
                                          <td width="199" align="left" valign="top" style="padding-left:20px;padding-top:10px;">&nbsp;<strong>Brand</strong>&nbsp;&nbsp;</td>
                                          <td width="310"  style="padding-top:10px;" valign="top">
                                          <span style="vertical-align:top">
...
<span style="vertical-align:top">
                                        ...
                                        <tr >
                                        <td width="199" style="padding-left:20px; padding-top:30px;"><strong>Select Year</strong></td>
