...
error_reporting(1);
	...
	$heading = "1 Euro Transaction Only";
	$todayDetails = getdate();
	
	$_POST['report_criteria']  =6;
	...
	*/
	...
	$reportQuery = "SELECT Brand,SUM(Count) AS Count FROM(".$reportQuery.")AS t5 GROUP BY t5.Brand";	
	...
	while($row = mysql_fetch_array($result1,MYSQL_ASSOC))
	{
		...
		$dat .= "data.setValue(".$i.", 0, '".$row['brand']."');"	;	
		$i++;
	...
	foreach($cmpArray AS $cmpArrays)
	{
		...
		{
			if(strtolower($cmpArrays['Brand']) == strtolower($resultArrays['Brand'])) 
					{						
						$dat .= 	"data.setValue(".$i.", 1, ".$resultArrays['Count'].");";
						$j ++;						
					}
		}
		if($j ==0)
				{
					$dat .= 	"data.setValue(".$i.", 1,0);";
				}
				$i++;	
	}
                        ...
                        <td width="11" height="9"><img src="images/top_right.jpg" width="9" height="9"></td>
                          ...
                          <tr> 
                            ...
                            <td valign="top"> 
                                ...
                                <tr>
                                          <td height="6" colspan="4" align="center" valign="bottom" class="sectionHeading" style="font-size:16px; padding-top:10px;">1 Euro Transaction Reports</td>
                                 </tr>                                    
                                    <TR> 
                                      <TD valign='top' bgColor='white'>
                                      <form name="reportFrm" action="report_oneeuro_chart.php" method="post" enctype="multipart/form-data" onSubmit="return dateValidation();">
                           ...
                           ?>
                                          ...
                                          <td width="111" align="left" valign="top" style="padding-left:10px;"><strong>Age</strong></td>
                                          <td width="161" valign="top" ><input type="text" name="user_fromage" id="user_fromage" size="5" value="<?=trim($_POST['user_fromage'])?>" />&nbsp;- &nbsp;<input type="text" name="user_toage" id="user_toage" size="5" value="<?=trim($_POST['user_toage'])?>"/></td>
                                        </tr>
                                        <tr >
                                        ...
                                        <tr>
                                          <td width="202" align="left" valign="top" style="padding-left:20px;padding-top:10px;">&nbsp;<strong>Brand</strong>&nbsp;&nbsp;</td>
                                          <td width="276"  style="padding-top:10px;" valign="top">
                                          <span style="vertical-align:top">
                                       ...
                                       <tr><td colspan="8" height="30">&nbsp;</td>
                                        ...
                                        <tr >
                                        <td width="202" style="padding-left:20px; padding-top:30px;"><strong>Filter Date</strong></td>
                                                ...
                                                echo $str;
                                            ?>
                                                  </select>                                                  <select name="frM" id="frM" style="font-size:11px;">
                                                    <?
                                                $mArray = array(
															""		=> "All",
                                                            "01" 	=> "January",
