...
error_reporting(1);
	...
	if($_POST['grouping']!='')
	{
		...
		{				
				$fileNameArray[5] = 'Query5.1.txt';		
		}
		if($grouping=='Country')
		{			
				$fileNameArray[5] = 'Query5.2.txt';	
		}
		if($grouping=='Gender')
		{			
				$fileNameArray[5] = 'Query5.3.txt';				
		}
		if($grouping=='Age')
		{			
				$fileNameArray[5] = 'Query5.4.txt';	
		}			
		if($grouping=='origin')
		{			
				$fileNameArray[5] = 'Query5.5.txt';				
		}
	...
	if($_REQUEST['export_to']== 2)$fileNameArray[5] = 'QueryExport5.txt';
                        ...
                        <td width="11" height="9"><img src="images/top_right.jpg" width="9" height="9"></td>
                          ...
                          <tr> 
                                ...
                                <tr>
                                 ...
                                 <?php if($_POST['report_criteria']!='')  include_once('exportform.php');?>   
                                    <TR> 
                                      ...
                                      <form name="reportFrm" action="report_gifcode.php" method="post" enctype="multipart/form-data">
                           ...
                           ?>
                                          ...
                                          <td width="140" align="left" valign="top" style="padding-left:10px;"><strong>Age</strong></td>
...
<span style="vertical-align:top">
                                          ...
                                          <option value="0" <?php foreach ($_POST['user_program'] as $value) {
                                            ...
                                            selected="selected"
											<?php } } ?>>No</option>                                   		  
                                          </select></span>											 <!-- <select id="user_program" name="user_program" style="font-size:11px;" >
