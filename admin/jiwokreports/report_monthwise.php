...
error_reporting(1);
	...
	if($_POST['grouping']!='')
	{
		...
		if($grouping=='brand_name')
			$fileNameArray[9] = 'Query9.1.txt';
		if($grouping=='Country')
			$fileNameArray[9] = 'Query9.2.txt';
		if($grouping=='Gender')
			$fileNameArray[9] = 'Query9.3.txt';
		if($grouping=='Age')
			$fileNameArray[9] = 'Query9.4.txt';
		if($grouping=='origin')
			$fileNameArray[9] = 'Query9.5.txt';	
	...
	if($_REQUEST['export_to']== 2)
		$fileNameArray[9] = 'QueryExport9.txt';
                                ...
                                <tr>
                                 ...
                                 <?php if($_POST['report_criteria']!='')  include_once('exportform.php');?>       
                                    <TR> 
                                      ...
                                      <form name="reportFrm" action="report_monthwise.php" method="post" enctype="multipart/form-data">
