...
error_reporting(1);
	...
	$heading = "Subscriber Reports Using Gift Code";
	$todayDetails = getdate();
	
	$_POST['report_criteria']  =5;
                        ...
                        <td width="11" height="9"><img src="images/top_right.jpg" width="9" height="9"></td>
                          ...
                          <tr> 
                            ...
                            <td valign="top"> 
                                ...
                                <tr>
                                          <td height="6" colspan="4" align="center" valign="bottom" class="sectionHeading" style="font-size:16px; padding-top:10px;">Giftcode Reports</td>
                                 </tr>                                     
                                    <TR> 
                                      <TD valign='top' bgColor='white'>
                                      <form name="reportFrm" action="report_gifcode_chart.php" method="post" enctype="multipart/form-data">
                           ...
                           ?>
                                          ...
                                          <td width="122" align="left" valign="top" style="padding-left:10px;"><strong>Age</strong></td>
                                          <td width="181" valign="top" ><input type="text" name="user_fromage" id="user_fromage" size="5" value="<?=trim($_POST['user_fromage'])?>" />&nbsp;- &nbsp;<input type="text" name="user_toage" id="user_toage" size="5" value="<?=trim($_POST['user_toage'])?>"/></td>
                                        </tr>
                                        <tr >
                                        ...
                                        <tr>
                                          <td width="230" align="left" valign="top" style="padding-left:20px;padding-top:10px;">&nbsp;<strong>Brand</strong>&nbsp;&nbsp;</td>
                                          <td width="217"  style="padding-top:10px;" valign="top">
                                          <span style="vertical-align:top">
