                            ...
                            <td valign="top"> 
                                ...
                                <tr>
                                 ...
                                 <?php if($_POST['report_criteria']!='') { ?>
                                  <form name="exportFrm" action="report.php" method="post" enctype="multipart/form-data">
                                 <tr>
                                   ...
                                   <?php } ?>     
                                    <TR> 
                                      ...
                                      <form name="reportFrm" action="report.php" method="post" enctype="multipart/form-data">
