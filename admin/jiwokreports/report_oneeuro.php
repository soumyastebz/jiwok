...
error_reporting(1);
	...
	if($_POST['grouping']!='')
	{
		...
		if($grouping=='brand_name')
			$fileNameArray[6] = 'Query6.1.txt';
		if($grouping=='Country')
			$fileNameArray[6] = 'Query6.2.txt';
		if($grouping=='Gender')
			$fileNameArray[6] = 'Query6.3.txt';
		if($grouping=='Age')
			$fileNameArray[6] = 'Query6.4.txt';
		if($grouping=='origin')
			$fileNameArray[6] = 'Query6.5.txt';	
	...
	if($_REQUEST['export_to']== 2)
		$fileNameArray[6] = 'QueryExport6.txt';
                        ...
                        <td width="11" height="9"><img src="images/top_right.jpg" width="9" height="9"></td>
                          ...
                          <tr> 
                                ...
                                <tr>
                                 ...
                                 <?php if($_POST['report_criteria']!='')  include_once('exportform.php');?>   
                                    <TR> 
                                      ...
                                      <form name="reportFrm" action="report_oneeuro.php" method="post" enctype="multipart/form-data" onSubmit="return dateValidation();">
                           ...
                           ?>
                                          ...
                                          <td width="144" align="left" valign="top" style="padding-left:10px;"><strong>Age</strong></td>
                                        ...
                                        <tr>
                                          ...
                                          <td width="243"  style="padding-top:10px;" valign="top">
                                          <span style="vertical-align:top">
