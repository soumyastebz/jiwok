                        ...
                        <td width="11" height="9"><img src="images/top_right.jpg" width="9" height="9"></td>
                          ...
                          <tr> 
                            ...
                            <td valign="top"> 
                                ...
                                <tr>
                                 ...
                                 <?php if($_POST['report_criteria']!='') { ?>
                                  <form name="exportFrm" action="report_subscribtion_grouping.php" method="post" enctype="multipart/form-data">
                                 <tr>
                                   ...
                                   <?php } ?>     
                                    <TR> 
                                      ...
                                      <form name="reportFrm" action="report_subscribtion_grouping.php" method="post" enctype="multipart/form-data" onSubmit="return dateValidation();">
                           ...
                           ?>
                                  ...
                                  <form name="grpFrm" action="report_subscribtion_grouping.php" method="post" enctype="multipart/form-data">
                                  <tr >
                                          <td align="right" valign="middle" style="padding-left:20px; padding-top:10px;">&nbsp;</td>
                                          <td style="padding-top:10px;"><strong>Group By</strong><select id="grouping" name="grouping" style="font-size:11px;" onChange="this.form.submit();" >
