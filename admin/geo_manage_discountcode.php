...
<tr> 
              ...
              <tr> 
				...
				<TABLE cellSpacing=0 cellPadding=0 border=0 align="center">
                 ...
                 <form name="frmcode" action="geo_manage_discountcode.php" method="post" >         
...
<tr> 
              ...
              <tr> 
			   ...
			   <form name="frmfaqs" action="geo_manage_discountcode.php" method="post">
				...
				<table cellspacing=0 cellpadding=0 width=553 border=0 class="topColor">
					...
					<tr>
						...
						<a href="geo_manage_discountcode.php?pageNob=1&type=<?=$_REQUEST['type']?>&maxrowsb=<?=$_REQUEST['maxrowsb']?>&field=<?=$_REQUEST['field']?>">
						<img src="images/mail-arrowfg.gif" border=0 width="20" height="20" align="absmiddle" alt="First Page"></a>
						<a href="geo_manage_discountcode.php?pageNob=<?=$prev?>&type=<?=$_REQUEST['type']?>&maxrowsb=<?=$_REQUEST['maxrowsb']?>&field=<?=$_REQUEST['field']?>">
						...
						<select name="pageNob" class="paragraph"  onChange="form.submit()">
							...
							?>
							 ...
							 of <?=$noOfPageb?>]
							 <a href="geo_manage_discountcode.php?pageNob=<?=$nextb?>&type=<?=$_REQUEST['type']?>&field=<?=$_REQUEST['field']?>&maxrowsb=<?=$_REQUEST['maxrowsb']?>">
							<img src="images/mail-arrowrg.gif" border=0 width="20" height="20" align="absmiddle" alt="Next Page"></a>
							<a href="geo_manage_discountcode.php?pageNob=<?=$noOfPageb?>&type=<?=$_REQUEST['type']?>&maxrowsb=<?=$_REQUEST['maxrowsb']?>&field=<?=$_REQUEST['field']?>">
              ...
              <tr> 
			   ...
			   <form name="frmfaqs" action="geo_manage_discountcode.php" method="post">
				...
				<table cellspacing=0 cellpadding=0 width=553 border=0 class="topColor">
					...
					<tr>
						<td align="left" colspan = "6" class="leftmenu">
						<a href="geo_manage_discountcode.php?pageNo=1&type=<?=$_REQUEST['type']?>&maxrows=<?=$_REQUEST['maxrows']?>&field=<?=$_REQUEST['field']?>">
						<img src="images/mail-arrowfg.gif" border=0 width="20" height="20" align="absmiddle" alt="First Page"></a>
						<a href="geo_manage_discountcode.php?pageNo=<?=$prev?>&type=<?=$_REQUEST['type']?>&maxrows=<?=$_REQUEST['maxrows']?>&field=<?=$_REQUEST['field']?>">
						<img src="images/mail-arrowlg.gif" border=0 width="20" height="20" align="absmiddle" alt="Previous Page"></a>[Page 
						<select name="pageNo" class="paragraph"  onChange="form.submit()">
							...
							?>
							 ...
							 of <?=$noOfPage?>]
							 <a href="geo_manage_discountcode.php?pageNo=<?=$next?>&type=<?=$_REQUEST['type']?>&field=<?=$_REQUEST['field']?>&maxrows=<?=$_REQUEST['maxrows']?>">
							<img src="images/mail-arrowrg.gif" border=0 width="20" height="20" align="absmiddle" alt="Next Page"></a>
							<a href="geo_manage_discountcode.php?pageNo=<?=$noOfPage?>&type=<?=$_REQUEST['type']?>&maxrows=<?=$_REQUEST['maxrows']?>&field=<?=$_REQUEST['field']?>">
							<img src="images/mail-arrowlastg.gif" border=0 width="20" height="20" align="absmiddle" alt="Last Page"></a>
						</td>
					</tr>
