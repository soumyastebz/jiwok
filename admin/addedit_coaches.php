                                        ...
                                        <TABLE class="paragraph2" cellSpacing=0 border="0" cellPadding=2 width="100%">
                                          <TBODY>
                                            ...
                                            <tr height="30px">
                                              ...
                                              <td>
                                              <input type="text" name="coach_name" id="coach_name" readonly="true" value="<?=$_POST['coach_name']?>" >
											  <?php /*?><select name="coach_name" id="coach_name" style="width:150px; height:20px;">
                                            ...
                                            <tr height="30px">
                                              ...
                                              <td><input type="file" name="coach_image">
                                                ...
                                                <img src="../uploads/coaches/<?=$currentImage?>" title="Coach" width="85" height="65" /><br/>
