...
$(selectorId).cropper('getCroppedCanvas').toBlob(function (blob) { 
 ...
 reader.onloadend = function() {
  ...
  $.ajax('uploader.php', {
    ...
    async: false,
    success: function (response) { 
	//alert(response);return false;exit;
		  window.location.href = "https://www.jiwok.com/admin/program_img.php?langId="+langId;
...
//need to remove above image/jpg if issue for png found
tabId += 1;
});// end loop
