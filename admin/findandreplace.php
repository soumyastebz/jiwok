...
*****************************************************************************/
	...
	if(isset($_POST['replace']))
	{
		...
		$program_lang		=	$_POST['program_lang'];
		$and				=	"";
		if($prgm_flex_id	==	"")
		{
				$sql_where	= 	"";
		...
		{
				$sql_where	= 	" flex_id ='".$prgm_flex_id."'";
		}
		...
		else
		{
			...
			else
			{
				...
				$sql_where1	= 	$and." language_id ='".$program_lang."'";
		}
				
		if(($sql_where =="") && ($sql_where1 == ""))
		{
			$where  ="";
		}
		else
		...
		$where				.=	$sql_where.$sql_where1;		
		$tbl				=	"program_detail_color";
		$flag				=	$objColor->_findAndReplace($tbl,$field,$find,$replace,$where);
		if($flag)
	...
	if(isset($_POST['replace1']))
	{
		...
		{
				$sql_where	= " workout_flex_id='".$wrk_out_flex_id."'";
		}
		if($program_lang	==	"All")
		{
				$sql_where1	= 	"";
		...
		else
		{
			...
			else
			{
				...
				$sql_where1	= 	$and." lang_id ='".$program_lang."'";
		}
		if(($sql_where =="") && ($sql_where1 == ""))
		{
			$where  ="";
				...
				<table cellSpacing=0 cellPadding=0 border=0 align="center">
				  ...
				  <tr>
					...
					<td align="left"><fieldset>
                     ...
                     <!-- Contents --->
                      <tr>
                             <td vAlign=top align=left width=200>Select Language </td>
                             <td width=200>
