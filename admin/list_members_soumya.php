<?php
 ...
 // echo $textmessage1;
	...
	if(trim($_REQUEST['keyword'])){
		...
		$searchQuery	=	" and  (user_fname like '%".$exp_keywords[0]."%' OR user_lname like '%".$exp_keywords[1]."%' OR user_email like '%".$exp_keywords[0]."%' OR user_email like '%".$exp_keywords[1]."%' OR user_alt_email like '%".$exp_keywords[0]."%' OR user_alt_email like '%".$exp_keywords[1]."%' OR email_history like '%".$exp_keywords[0]."%' OR email_history like '%".$exp_keywords[1]."%' OR paybox_email like '%".$exp_keywords[0]."%' OR paybox_email like '%".$exp_keywords[1]."%')";	
		...
		$searchQuery	=	" and  (user_fname like '%".$cleanData."%' OR user_lname like '%".$cleanData."%' OR user_email like '%".$cleanData."%' OR user_alt_email like '%".$cleanData."%' OR email_history like '%".$cleanData."%' OR paybox_email like '%".$cleanData."%')";	
	...
	if($page_name!= "")
	{
		$query = "SELECT count(*) as max FROM user_master WHERE user_language=5 and user_type=".$siteUsersConfig['MEMBER'];
		//die("SELECT count(*) as max FROM user_master WHERE user_language=5 anduser_type=".$siteUsersConfig['MEMBER']);
	}
	else 
	{
	...
	if($_REQUEST['pageNo']){
		...
		$result = $memObj->_showPage($siteUsersConfig['MEMBER'],$totalRecs,$_REQUEST['pageNo'],$_REQUEST['maxrows'],$field,$type,$searchQuery,$page_name);
