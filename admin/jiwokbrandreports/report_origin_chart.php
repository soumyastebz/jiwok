...
session_start();
	...
	*/
	...
	while($row = mysql_fetch_array($result,MYSQL_ASSOC))
	{
		...
		$resultArray[$i]['cat'] = $row['User Origin'];
	...
	$dat = "data.addRows(4);";	
	$cmpArray = array('0'=>'1Euro','1'=>'Giftcode','2'=>'FWT','3'=>'7.9/9.9 trans');
	/*echo "<pre/>";
	print_r($cmpArray);
	die;*/
	$dat .= "data.setValue(0, 0, '1Euro');data.setValue(1, 0, 'Giftcode');data.setValue(2, 0, 'FWT');data.setValue(3, 0, '7.9/9.9 trans');"	;	
	$i = 0;
	foreach($cmpArray AS $cmpArrays)
	{
		...
		{
			if(strtolower($cmpArrays) == strtolower($resultArrays['cat']))
					{						
                        ...
                        <td width="11" height="9"><img src="images/top_right.jpg" width="9" height="9"></td>
                          ...
                          <tr> 
                            ...
                            <td valign="top"> 
                                ...
                                <tr>
                                          <td height="6" colspan="4" align="center" valign="bottom" class="sectionHeading" style="font-size:16px; padding-top:10px;">Origin Reports</td>
                                 </tr>
                                   
                                    <TR> 
                                      <TD valign='top' bgColor='white'>
                                      <form name="reportFrm" action="report_origin_chart.php" method="post" enctype="multipart/form-data">
                                      <table width=100% height="227" border=0 cellpadding=0 cellspacing=0 class="paragraph2">
                                        ...
                                        <tr >
                                          <td width="215" align="left" valign="top" style="padding-left:20px;">&nbsp;<strong>Country</strong>&nbsp;&nbsp;</td>
                                          <td width="195" >
                           ...
                           ?>
                                          ...
                                          <td width="156" align="left" valign="top" style="padding-left:10px;"><strong>Age</strong></td>
                                          <td width="176" valign="top" ><input type="text" name="user_fromage" id="user_fromage" size="5" value="<?=trim($_POST['user_fromage'])?>" />&nbsp;- &nbsp;<input type="text" name="user_toage" id="user_toage" size="5" value="<?=trim($_POST['user_toage'])?>"/></td>
                                        </tr>
                                        <tr >
