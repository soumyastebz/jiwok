...
session_start();
	...
	*/
	...
	$data = "data.addColumn('string', 'Program name');data.addColumn('number', 'Count');data.addRows(".$totalRows.");";
	$i = 0;
	while($row = mysql_fetch_array($result,MYSQL_ASSOC))
	{
		$data .= "data.setValue(".$i.", 0, '".addslashes($row['program_title'])."'); data.setValue(".$i.", 1, ".$row['Count'].");";
		$i++;
	}	
	}
                            ...
                            <td valign="top"> 
                                ...
                                <tr>
                                    ...
                                    <TR> 
                                      ...
                                      <form name="reportFrm" action="report_training_chart.php" method="post" enctype="multipart/form-data">
