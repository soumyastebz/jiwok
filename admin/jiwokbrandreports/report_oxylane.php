...
session_start();
	...
	$codeArray = $reportObj->getAllOxyCodes(strtolower($brand_name));
	
	$heading = "Oxylane Report";
	$todayDetails = getdate();	
	
	$brandArray		= $reportObj->getOxyBrandName(strtolower($brand_name));									  	
	if(!empty($brandArray))
	{
		$brandCondn = " AND (";
		...
		{		
			$conditionArray[]= " cn.id=".$brandArrays['id'];			 	
		}
	...
	{
		$brandCondn = " AND cn.camp_name = '$brand_name' ";	
	}
	...
	*/
	...
	$reportQuery = sprintf($reportQuery,$frD,$frM,$frY,$toD,$toM,$toY,$countryCondn,$genderCondn,$originCondn,$discCondn,$ageCondn1,$ageCondn2,$brandCondn,$typeCondn,$programCondn,$codeCondn,$languageCondn);	
                                ...
                                <tr>
                                 ...
                                 <?php if($_POST['report_criteria']!='')  include_once('exportform.php');?>        
                                    <TR> 
                                      ...
                                      <form name="reportFrm" action="report_oxylane.php" method="post" enctype="multipart/form-data">
