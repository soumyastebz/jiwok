	...
	function showPopUnderFull(id,origin) {
	...
	function handleHttpResponseAddress() {	
	  ...
	  if (http.readyState == 4) {
		...
		if(parseInt(results) == 2){
			var strHtml = "<div class=\"close\" align=\"left\"><a href=\"javascript:hidePopUnder('errMessage')\" class=\"blackwhite\"><b>X</b></a> </div>";
			strHtml+="<table width=\"100%\"><tr><td colspan=\"2\" align=\"center\">&nbsp;</td></tr>";
			strHtml+= "<tr><td colspan=\"2\" align=\"center\" class=\"blacktext\">Your login details will be mailed to the provided e-mail address</td></tr>";
			...
			strHtml+="<table width=\"100%\"><tr><td colspan=\"2\" align=\"center\">&nbsp;</td></tr>";
			strHtml+= "<tr><td colspan=\"2\" align=\"center\" class=\"blacktext\">The email address does not match any record in our database!!</td></tr>";
			strHtml+="<tr><td colspan=\"2\" align=\"center\">&nbsp;</td></tr></table>";
			document.getElementById("errMessage").style.display = "block";
			document.getElementById("errMessage").innerHTML = strHtml;			
		}			
