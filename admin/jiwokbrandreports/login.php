<?php
	...
	if($_POST['submit'])
	{
		if(trim($_POST["user_name"])=="")
			...
			//new block
			$query="SELECT * FROM brand_master WHERE BINARY brand_email='".addslashes($username)."' and  
						brand_password='".addslashes($password)."' and brand_status='1'";
			...
			if($numRows>0) {
				...
				$_SESSION['brand_master_id'] = $row['brand_master_id'];
          ...
          <TR>
                   ...
                   <TR>
                     <TD width="100%" height=323 align="center"> 
                         ...
                         <table align="center"  border="0" cellspacing="0" cellpadding="0">
						  ...
						  <FONT color=#002f8d>Please enter your Email &amp; password...</FONT></SPAN> 
                          </P>
			...
			?>			     
                  ...
                  <TABLE cellSpacing=0 cellPadding=3 width="100%" border=0>
                    <TBODY>
                      <TR>
                         <TD width="35%"><STRONG><SPAN style="FONT-SIZE: 8pt; FONT-FAMILY: Verdana"><font color="E83E1B">Email:</font></SPAN></STRONG></TD>
                         <TD width="65%" colspan="2"><INPUT  type="text" class="field" value="<?=stripslashes($_POST['user_name'])?>" style="FONT-SIZE: 10pt; FONT-FAMILY: Arial" size=13 
                          name="user_name"> 
						 </TD>
					  </TR>
                      <TR>
                         ...
                         <TD width="65%" colspan="2"><INPUT class="field" style="FONT-SIZE: 10pt; FONT-FAMILY: Arial" 
                          type="password" value="<?=stripslashes($_POST['upass'])?>" size=13 name="upass" onKeyUp="javascript:notcontrolpaste(event);" onMouseUp="javascript:notcontrolpaste(event);" > 
						 </TD>
					  </TR>
                      <TR>
                      	<TD width="35%"></TD>
