...
session_start();
	...
	if($_REQUEST['export_to']== 2)
		$fileNameArray[25] = 'QueryExport25.txt';
                        ...
                        <td width="11" height="9"><img src="images/top_right.jpg" width="9" height="9"></td>
                          ...
                          <tr> 
                                 ...
                                 <?php if($_POST['report_criteria']!='') { 
                                  include("exportform.php");
                                    ...
                                    <TR> 
                                      ...
                                      <form name="reportFrm" action="report_testplan.php" method="post" enctype="multipart/form-data" onSubmit="return dateValidation();">
                           ...
                           ?>
                                          ...
                                          <td width="125" align="left" valign="top" style="padding-left:10px;"><strong>Age</strong></td>
