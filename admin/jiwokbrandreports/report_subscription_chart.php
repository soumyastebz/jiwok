...
session_start();
	...
	*/
	...
	$dat = "data.addRows(4);";	
	$cmpArray = array('0'=>'Registered Not Tested','1'=>'Registered and Tested','2'=>'Subscriber','3'=>'Ex-Subscriber');
	/*echo "<pre/>";
	print_r($cmpArray);
	die;*/
	$dat .= "data.setValue(0, 0, 'Registered Not Tested');data.setValue(1, 0, 'Registered and Tested');data.setValue(2, 0, 'Subscriber');data.setValue(3, 0, 'Ex-Subscriber');"	;	
	$i = 0;
...
<span style="vertical-align:top">
                                        ...
                                        <tr>
                                         ...
                                         <td width="270"  style="padding-top:10px;" valign="top">
										 <span style="vertical-align:top">
