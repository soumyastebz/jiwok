...
session_start();
	...
	{
		$dat .="data.setValue(".$i.", 0, '".$row['Country']."');data.setValue(".$i.", 1,".$row['Count'].");";
		$i++;
	}			
	}
?>
                        ...
                        <td width="11" height="9"><img src="images/top_right.jpg" width="9" height="9"></td>
                          ...
                          <tr> 
                                ...
                                <tr>
                                    ...
                                    <TR> 
                                      ...
                                      <table width=100% height="227" border=0 cellpadding=0 cellspacing=0 class="paragraph2">
                                        ...
                                        <tr >
                                          <td width="250" align="left" valign="top" style="padding-left:20px;">&nbsp;<strong>Country</strong>&nbsp;&nbsp;</td>
                                          <td width="144" >
                           ...
                           ?>
                                          ...
                                          <td width="172" align="left" valign="top" style="padding-left:10px;"><strong>Age</strong></td>
