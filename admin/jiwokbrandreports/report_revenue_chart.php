...
session_start();
	...
	*/
	...
	$dat = "data.addRows(2);";	
	$dat .= "data.setValue(0, 0, 'Euro');data.setValue(1, 0, 'Dollar');"	;
	$resultArray = array();
	$i = 0;
	while($row = mysql_fetch_array($result,MYSQL_ASSOC))
	{
		...
		$resultArray[$i]['Count'] = $row['Total Amount'];
		$i++;
	}	
	$fields = mysql_num_fields($result);
	
	$totalRows = mysql_num_rows($result);
	$cmpArray = array('0'	=>	'Euro','1'	=>	'Dollar');	
	$i = 0;
      ...
      function drawChart() {
	   ...
	   var chart = new google.visualization.ColumnChart(document.getElementById('chart_div'));
        chart.draw(data, {height: 440,
                          hAxis: {title: 'Currency', titleTextStyle: {color: 'red'}},
                            ...
                            <td valign="top"> 
                                ...
                                <tr>
                                    ...
                                    <TR> 
                                      ...
                                      <form name="reportFrm" action="report_revenue_chart.php" method="post" enctype="multipart/form-data">
