                        ...
                        <td width="11" height="9"><img src="images/top_right.jpg" width="9" height="9"></td>
                          ...
                          <tr> 
                            ...
                            <td valign="top">                             
                                ...
                                <tr>
                                          <td height="6" colspan="4" align="center" valign="bottom" class="sectionHeading" style="font-size:16px; padding-top:10px;"><span class="sectionHeading" style="font-size:16px; padding-top:10px;">Revenue</span> Reports</td>
                                 </tr>
                                  ...
                                  include("exportform.php");
                                    ...
                                    <TR> 
                                      ...
                                      <form name="reportFrm" action="report_revenue.php" method="post" enctype="multipart/form-data">
