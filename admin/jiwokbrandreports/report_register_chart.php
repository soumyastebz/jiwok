...
session_start();
	...
	*/
	...
	$dat = "data.addRows(3);";	
	$dat .= "data.setValue(0, 0, 'new');data.setValue(1, 0, 'Existing');data.setValue(2, 0, 'other');"	;
	$resultArray = array();
	$i = 0;
	...
	$cmpArray = array('0'	=>	array('cat'	=>	'new','catnb'	=> 1),'1'	=>	array('cat'	=>	'Existing','catnb'	=> 2),'3'	=>	array('cat'	=>	'other','catnb'	=> 3));
	...
	foreach($cmpArray AS $cmpArrays)
	{
		...
		{
			if((strtolower($cmpArrays['cat']) == strtolower($resultArrays['cat'])))
					{						
                            ...
                            <td valign="top"> 
                                ...
                                <tr>
                                    ...
                                    <TR> 
                                      ...
                                      <form name="reportFrm" action="report_register_chart.php" method="post" enctype="multipart/form-data">
