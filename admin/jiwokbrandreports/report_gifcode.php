...
session_start();
	...
	if($_REQUEST['export_to']== 2)
		$fileNameArray[5] = 'QueryExport5.txt';
                        ...
                        <td width="11" height="9"><img src="images/top_right.jpg" width="9" height="9"></td>
                          ...
                          <tr> 
                                  ...
                                  include("exportform.php");
                                    ...
                                    <TR> 
                                      ...
                                      <table width=100% height="227" border=0 cellpadding=0 cellspacing=0 class="paragraph2">
                                        ...
                                        <tr >
                                          <td width="218" align="left" valign="top" style="padding-left:20px;">&nbsp;<strong>Country</strong>&nbsp;&nbsp;</td>
                                          <td width="213" >
                           ...
                           ?>
                                          ...
                                          <td width="135" align="left" valign="top" style="padding-left:10px;"><strong>Age</strong></td>
