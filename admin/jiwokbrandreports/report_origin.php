...
session_start();
	...
	if($_REQUEST['export_to']== 2)
		$fileNameArray[2] = 'QueryExport2.txt';
                                 ...
                                 <?php if($_POST['report_criteria']!='') {
                                  include("exportform.php");
                                    ...
                                    <TR> 
                                      ...
                                      <form name="reportFrm" action="report_origin.php" method="post" enctype="multipart/form-data">
                                      <table width=100% height="227" border=0 cellpadding=0 cellspacing=0 class="paragraph2">
                                        ...
                                        <tr >
                                          <td width="201" align="left" valign="top" style="padding-left:20px;">&nbsp;<strong>Country</strong>&nbsp;&nbsp;</td>
                                          <td width="205" >
