...
session_start();
	...
	*/
	...
	$dat = "data.addColumn('number', 'Count');";
	$resultArray = array();
	$i = 0;
	...
	//To get total brands	
	$cmpArray = array('0'=>'Test First workout','1'=>'Test 1 euro');
	$dat .= "data.addRows(2);data.setValue(0, 0, 'Test First workout');data.setValue(1, 0, 'Test 1 euro');";	
                        ...
                        <td width="11" height="9"><img src="images/top_right.jpg" width="9" height="9"></td>
                          ...
                          <tr> 
                           ...
                           ?>
                                          ...
                                          <td width="145" align="left" valign="top" style="padding-left:10px;"><strong>Age</strong></td>
                                          <td width="174" valign="top" ><input type="text" name="user_fromage" id="user_fromage" size="5" value="<?=trim($_POST['user_fromage'])?>" />&nbsp;- &nbsp;<input type="text" name="user_toage" id="user_toage" size="5" value="<?=trim($_POST['user_toage'])?>"/></td>
                                        </tr>
                                        <tr >
                                         ...
                                         <tr >
                                          ...
                                          <td style="padding-top:10px;"><select id="origin_select" name="origin_select" style="font-size:11px;" onChange="javascript:selectOrigin(this.value);">
