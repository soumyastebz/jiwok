...
*****************************************************************************/
	...
	$qryIap		="select a.payment_duration,a.status,a.payment_currency,a.plan_id,a.discount_amount,b.plan_name,b.plan_amount from payment_iap a 
				LEFT JOIN jiwok_payment_plan  b ON a.payment_duration=b.plan_id 
				WHERE a.user_id=".$userId." and IF(a.payment_currency = 'Euro', 2, 1) = b.plan_currency order by a.id desc";
