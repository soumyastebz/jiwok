				   ...
				   <TBODY> 
					 ...
					 <?php }
						...
						?>
							...
							<TD align="center">
                            <a href = "add_coachCat_home.php?coachCatId=<?=$row['id']?>&pageNo=<?=$_REQUEST['pageNo']?>&langId=<?=$lanId?>&maxrows=<?=$_REQUEST['maxrows']?>&field=<?=$_REQUEST['field']?>&type=<?=$_REQUEST['type']?>&keyword=<?=$objGen->_output($_REQUEST['keyword'])?>&action=add" class="smallLink">Add</a>
                            |
