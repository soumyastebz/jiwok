...
/**************************************************************************** 
   Project Name	::> Jiwok 
   Module 		::> Admin-gift code manage section of geonaute payment service.
   Programmer	::> Dileep
   Date			::> 14/01/2013
			   ...
			   <form name="frmfaqs" action="manage_giftcode.php" method="post">
				...
				<table cellspacing=0 cellpadding=0 width=553 border=0 class="topColor">
					...
					<tr>
						...
						<a href="manage_giftcode.php?pageNo=1&type=<?=$_REQUEST['type']?>&langId=<?=$lanId?>&maxrows=<?=$_REQUEST['maxrows']?>&field=<?=$_REQUEST['field']?>&keywordab=<?=$objGen->_output($_REQUEST['keywordab'])?>&keyab=<?=$objGen->_output($keyab)?>">
						<img src="images/mail-arrowfg.gif" border=0 width="20" height="20" align="absmiddle" alt="First Page"></a>
						<a href="manage_giftcode.php?pageNo=<?=$prev?>&type=<?=$_REQUEST['type']?>&langId=<?=$lanId?>&maxrows=<?=$_REQUEST['maxrows']?>&field=<?=$_REQUEST['field']?>&keywordab=<?=$objGen->_output($_REQUEST['keywordab'])?>&keyab=<?=$objGen->_output($keyab)?>">
						...
						<select name="pageNo" class="paragraph"  onChange="form.submit()">
							...
							?>
							 ...
							 of <?=$noOfPage?>]
							 <a href="manage_giftcode.php?pageNo=<?=$next?>&type=<?=$_REQUEST['type']?>&langId=<?=$lanId?>&field=<?=$_REQUEST['field']?>&maxrows=<?=$_REQUEST['maxrows']?>&keywordab=<?=$objGen->_output($_REQUEST['keywordab'])?>&keyab=<?=$objGen->_output($keyab)?>">
							<img src="images/mail-arrowrg.gif" border=0 width="20" height="20" align="absmiddle" alt="Next Page"></a>
							<a href="manage_giftcode.php?pageNo=<?=$noOfPage?>&type=<?=$_REQUEST['type']?>&langId=<?=$lanId?>&maxrows=<?=$_REQUEST['maxrows']?>&field=<?=$_REQUEST['field']?>&keywordab=<?=$objGen->_output($_REQUEST['keywordab'])?>&keyab=<?=$objGen->_output($$keyab)?>">
      ...
      button      : "to_date_btn"       // ID of the button
				  ...
				  <TABLE class="listTableStyle" cellSpacing=1 cellPadding=2 width="691">
				   <TBODY> 
					 ...
					 <?php }
						...
						$a= $obj->_getcount($row['code']); 
						$b= $row['no_usage']-$a[0]['cnt']; 
						?>
						    <tr class="listingTable">
				...
				<table cellspacing=0 cellpadding=0 width=691 border=0 class="topColor">
					...
					<tr>
						...
						<a href="manage_giftcode.php?pageNob=1&typeb=<?=$_REQUEST['typeb']?>&langIdb=<?=$lanIdb?>&maxrowsb=<?=$_REQUEST['maxrowsb']?>&fieldb=<?=$_REQUEST['fieldb']?>&keywordb=<?=$_REQUEST['keywordb']?>&keyb=<?=$keyb?>&searchkey=<?=$_REQUEST['searchkey']?>&from_date=<?=$_REQUEST['from_date']?>&to_date=<?=$_REQUEST['to_date']?>">
						<img src="images/mail-arrowfg.gif" border=0 width="20" height="20" align="absmiddle" alt="First Page"></a>
						<a href="manage_giftcode.php?pageNob=<?=$prevb?>&typeb=<?=$_REQUEST['typeb']?>&langIdb=<?=$lanIdb?>&maxrowsb=<?=$_REQUEST['maxrowsb']?>&fieldb=<?=$_REQUEST['fieldb']?>&keywordb=<?=$_REQUEST['keywordb']?>&keyb=<?=$keyb?>&searchkey=<?=$_REQUEST['searchkey']?>&from_date=<?=$_REQUEST['from_date']?>&to_date=<?=$_REQUEST['to_date']?>">
						<img src="images/mail-arrowlg.gif" border=0 width="20" height="20" align="absmiddle" alt="Previous Page"></a>[Page 
						<select name="pageNob" class="paragraph"  onChange="form.submit()">
							...
							?>
							 ...
							 of <?=$noOfPageb?>]
							 <a href="manage_giftcode.php?pageNob=<?=$nextb?>&typeb=<?=$_REQUEST['typeb']?>&langIdb=<?=$lanIdb?>&fieldb=<?=$_REQUEST['fieldb']?>&maxrowsb=<?=$_REQUEST['maxrowsb']?>&keywordb=<?=$_REQUEST['keywordb']?>&keyb=<?=$keyb?>&searchkey=<?=$_REQUEST['searchkey']?>&from_date=<?=$_REQUEST['from_date']?>&to_date=<?=$_REQUEST['to_date']?>">
							<img src="images/mail-arrowrg.gif" border=0 width="20" height="20" align="absmiddle" alt="Next Page"></a>
							<a href="manage_giftcode.php?pageNob=<?=$noOfPageb?>&typeb=<?=$_REQUEST['typeb']?>&langIdb=<?=$lanIdb?>&maxrowsb=<?=$_REQUEST['maxrowsb']?>&fieldb=<?=$_REQUEST['fieldb']?>&keywordb=<?=$_REQUEST['keywordb']?>&keyb=<?=$keyb?>&searchkey=<?=$_REQUEST['searchkey']?>&from_date=<?=$_REQUEST['from_date']?>&to_date=<?=$_REQUEST['to_date']?>">
							<img src="images/mail-arrowlastg.gif" border=0 width="20" height="20" align="absmiddle" alt="Last Page"></a>
						</td>
