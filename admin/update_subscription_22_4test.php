...
*****************************************************************************/
	...
	include_once('../includes/classes/class.newpayment_test.php');
	...
	$objGen			=	new General();
	$paymentClass	=	new newPayment_test();
	...
	if(sizeof($errorMsg)==0){
		...
		{
			$res	=	$paymentClass->unsubsriptionFromPaybox($payboxStatus[0][id]);	echo $res;exit;		
		   	if($res == '00000')
		   	{
