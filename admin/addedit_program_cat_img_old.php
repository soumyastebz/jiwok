...
-->                     </td>
					...
					<tr>
						...
						<td>
							...
							<a href="#" title="Previous image" onClick="openNewWindow('../uploads/category/<?=$currentImage?>','windowname',<?=(100);?>,<?=(50);?>)">View</a>
                        </td>
					</tr>
					<?php }?>
					<tr>
						 ...
						 <input type="submit" name="update" onClick="return formChecking()" value="&nbsp;Update&nbsp;"></td>
					</tr>
