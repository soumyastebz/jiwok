...
/**************************************************************************** 
   ...
   DESCRIPTION::::>>>>
   This  code userd to list subscription programs of a user.
...
*****************************************************************************/
	...
	*/
	...
	$heading = "Subscription Programs";
	$userId =    base64_decode($_REQUEST['userId']);
	
	$sql = "SELECT program_name,subscribed_date FROM programs_subscribed,program_manager WHERE programs_subscribed.program_id = program_manager.programmaster_id AND programs_subscribed.user_id = '".$userId." 'AND program_manager.language_id = 1  ORDER BY subscribed_date DESC";	
              ...
              <tr> 
				...
				<TABLE cellSpacing=0 cellPadding=0 border=0 align="center">
				  ...
				  <tr>
				  	...
				  	<tr>
						<td valign="middle" height="30" align="right" ><a href="list_members.php?pageNo=<?=$_REQUEST['pageNo']?>&maxrows=<?=$_REQUEST['maxrows']?>&field=<?=$_REQUEST['field']?>&type=<?=$_REQUEST['type']?>&keyword=<?=$genObj->_output($_REQUEST['keyword'])?>"><img src="images/list.gif" alt="Listing Record">&nbsp;List Members </a></td>
					</tr>
				  </table>
				  ...
				  <TABLE class="listTableStyle" cellSpacing=1 cellPadding=2 width="553">
				   <TBODY> 
					   <TR class="tableHeaderColor">
						...
						<TD width="31%" align="left" colspan="2" >Subscribed Date </TD>
					  ...
					  <?php if($errMsg != ""){?>
					      ...
					      <? if(count($result)>0){?>
							...
							<TD width="53%" height="19" align="left" style="padding-left:10px;"><? echo $val['program_name'];?></TD>
							
							<TD  width="31%" height="19" align="left" style="padding-left:10px;"><? echo $val['subscribed_date'];?></TD>
