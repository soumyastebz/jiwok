<? 
 ...
 //for generating the excell sheet for the report
	...
	$sql = "SELECT user_master.user_id,user_fname,user_gender,user_lname,user_alt_email AS user_email,user_address,user_city,user_state,user_country,DATE_FORMAT(user_doj,'%W %D %M %Y') AS date	 FROM ".$PostQuerry;
